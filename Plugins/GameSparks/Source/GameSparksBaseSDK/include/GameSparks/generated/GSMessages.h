		...
		namespace Messages
		{
			...
			*/
			class AchievementEarnedMessage : public GSMessage
			{
				...
				/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrencyAwards () const
					{
						return m_Response.GetGSDataObject("currencyAwards");
					}
				/// <summary>
			...
			*/
			class ChallengeWonMessage : public GSMessage
			{
				...
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency1Won () const
					{
						return m_Response.GetLongLong("currency1Won");
					}
				/// <summary>
				/// The amount of type 2 currency the player has won.
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency2Won () const
					{
						return m_Response.GetLongLong("currency2Won");
					}
				/// <summary>
				/// The amount of type 3 currency the player has won.
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency3Won () const
					{
						return m_Response.GetLongLong("currency3Won");
					}
				/// <summary>
				/// The amount of type 4 currency the player has won.
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency4Won () const
					{
						return m_Response.GetLongLong("currency4Won");
					}
				/// <summary>
				/// The amount of type 5 currency the player has won.
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency5Won () const
					{
						return m_Response.GetLongLong("currency5Won");
					}
				/// <summary>
				/// The amount of type 6 currency the player has won.
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency6Won () const
					{
						return m_Response.GetLongLong("currency6Won");
					}
				/// <summary>
				/// An object containing the short codes and amounts of the currencies the player has won
				/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrencyWinnings () const
					{
						return m_Response.GetGSDataObject("currencyWinnings");
					}
				/// <summary>
				/// The leaderboard data associated with this challenge.
				/// </summary>
			...
			*/
			class GlobalRankChangedMessage : public GSMessage
			{
				...
				/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGameId () const
					{
						return m_Response.GetLongLong("gameId");
					}
				/// <summary>
